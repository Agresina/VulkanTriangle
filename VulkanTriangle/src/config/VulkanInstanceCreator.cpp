...
void VulkanInstanceCreator::setupValidationLayers(VulkanEngine& vkEngine, VkInstanceCreateInfo createInfo) {
    if (vkEngine.enableValidationLayers) {
        ...
        VkDebugUtilsMessengerCreateInfoEXT debugCreateInfo = debugMessengerCreateInfo(vkEngine);
...
VkDebugUtilsMessengerCreateInfoEXT debugMessengerCreateInfo(VulkanEngine& vkEngine) {
